import { Island, Achatina, Allosaurus, Anglerfish, Ankylosaurus, Araneo, Archaeopteryx, Argentavis, Arthropluera} from "./index";
import { Baryonyx, Basilosaurus, Beelzebufo, Brontosaurus } from "./index";
import { Carbonemys, Carnotaurus, Castoroides, Chalicotherium, Compy } from "./index";
import { Daeodon, Dilophosaurus, Dimetrodon, Dimorphodon, Diplocaulus, Diplodocus, DireBear, Direwolf, Dodo, Doedicurus, Dunkleosteus } from "./index";
import { Electrophorus, Equus, Gallimimus, Giganotosaurus, Gigantopithecus, Hesperonis, Hyaenodon } from "./index";
import { Ichthyornis, Ichthyosaurus, Iguanodon, Kairuku, Kaprosuchus, Kentrosaurus } from "./index";
import { Lystrosaurus, Mammoth, Manta, Megalania, Megaloceros, Megalodon, Megalosaurus, Megatherium, Mesopithecus, Microraptor, Mosasaurus, Moschops } from "./index";
import { Onyc, Otter, Oviraptor, Ovis, Pachycephalosaurus, Pachyrhinosaurus, Paraceratherium, Parasaur, Pegomastax, Pelagornis, Phiomia, Plesiosaur, Procoptodon, Pteranodon, Pulmonoscorpius, Purlovia } from "./index";
import { Quetzalcoatlus, Raptor, Rex, Sabertooth, Sarcosuchus, Spinosaurus, Stegosaurus } from "./index";
import { Tapejara, TerrorBird, Therizinosaur, Thylacoleo, Triceratops, Troodon, Tusoteuthis, WoolyRhino, Yutyrannus } from "./index";
...
const IslandRoutes = () => {
    return(
        ...
        <Route path="/maps/island/chalicotherium" element={<Chalicotherium/>}/>
        <Route path="/maps/island/compy" element={<Compy/>}/>
        <Route path="/maps/island/daeodon" element={<Daeodon/>}/>
        <Route path="/maps/island/dilophosaur" element={<Dilophosaurus/>}/>
        ...
        <Route path="/maps/island/giganotosaurus" element={<Giganotosaurus/>}/>
        <Route path="/maps/island/gigantopithecus" element={<Gigantopithecus/>}/>
        ...
        <Route path="/maps/island/pachyrhinosaurus" element={<Pachyrhinosaurus/>}/>
        <Route path="/maps/island/paraceratherium" element={<Paraceratherium/>}/>
        ...
        <Route path="/maps/island/pulmonoscorpius" element={<Pulmonoscorpius/>}/>
        <Route path="/maps/island/purlovia" element={<Purlovia/>}/>
        <Route path="/maps/island/quetzalcoatlus" element={<Quetzalcoatlus/>}/>
